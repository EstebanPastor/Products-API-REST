package com.chinodev.SpringbootRestApi.controllers;

import com.chinodev.SpringbootRestApi.controllers.DTO.MakerDTO;
import com.chinodev.SpringbootRestApi.entities.Maker;
import com.chinodev.SpringbootRestApi.service.IMakerService;
...
public class MakerController {
    ...
    public ResponseEntity<?> deleteByiD(@PathVariable Long id) {
        if(id != null) {
            ...
            return ResponseEntity.ok("Registry deleted");
        } else {
            return ResponseEntity.badRequest().build();
        }
        }
